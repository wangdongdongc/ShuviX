#!/usr/bin/env python3
"""
slides_en.py — kami slide deck library (16:9, parchment aesthetic, Inter + Newsreader)
...
│                                                                      │
│  If unsure, re-read Step 6B of SKILL.md. Do not improvise.           │
└──────────────────────────────────────────────────────────────────────┘

Standalone use (outside ShuviX):
  pip install python-pptx
  from slides_en import cover_slide, ...
  Then call main() or build your own deck.
"""
