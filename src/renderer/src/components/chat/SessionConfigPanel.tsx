...
import { ChevronDown, Copy, FileText, Globe, RefreshCw, TriangleAlert, X } from 'lucide-react'
...
// ────────────────────────────────────────────────────────────────
// 局部 UI 组件（card + row + toggle + inline select）
// ────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="relative inline-block">
      <select
        ...
        className="appearance-none bg-bg-tertiary/70 hover:bg-bg-hover rounded-md pl-2.5 pr-7 py-1 text-[11px] text-text-primary border border-border-secondary/50 transition-colors cursor-pointer max-w-[180px] truncate focus:outline-none focus:border-accent/60"
      >
        {children}
      </select>
      <ChevronDown
