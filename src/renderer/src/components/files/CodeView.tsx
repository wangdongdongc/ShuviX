...
import { loadLanguage } from './codeMirror/languageLoader'
import { buildCmTheme } from './codeMirror/codeMirrorTheme'
...
export function CodeView({ content, ext, wrap, lineNumbers }: CodeViewProps): React.JSX.Element {
  ...
  useEffect(() => {
    const obs = new MutationObserver(() => {
      viewRef.current?.dispatch({ effects: themeC.reconfigure(buildCmTheme()) })
    })
