 ...
 * 以卡片网格方式展示所有 widget，点击跳转 Preview tab 打开该 widget
 */
  ...
  return (
    <div className="flex flex-col h-full bg-bg-primary overflow-hidden">
      ...
      <div className="titlebar-drag flex-shrink-0 flex items-center gap-2 px-3 min-h-8 border-b border-border-secondary/30">
        <Wrench size={12} className="flex-shrink-0 text-violet-400" />
...
function WidgetCard({
  ...
  return (
    <div
      ...
      className="group relative rounded-md border border-border-secondary/40 bg-bg-secondary/30 hover:border-violet-400/50 hover:bg-bg-hover/60 transition-colors cursor-pointer p-2.5"
    >
      <div className="flex items-start gap-2">
        <div className="flex-shrink-0 w-7 h-7 rounded-md bg-violet-400/15 flex items-center justify-center">
