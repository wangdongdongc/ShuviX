...
const AGENT_DESCRIPTOR: ShuvixMdTypeDescriptor = {
  ...
  fields: [
    ...
    { key: 'shuvix-instruction-files', labelKey: 'tool.subAgentInstructionFiles', kind: 'boolean' },
    { key: 'shuvix-project-prompt', labelKey: 'tool.subAgentProjectPrompt', kind: 'boolean' },
    { key: 'shuvix-dispatch-only', labelKey: 'tool.subAgentDispatchLabel', kind: 'boolean' }
  ]
}
