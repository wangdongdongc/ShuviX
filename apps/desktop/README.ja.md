...
- 📁 **プロジェクトサンドボックス** — AI のアクセスをプロジェクトディレクトリ内に制限可能。シェルコマンドはユーザーの確認後に実行
- 💾 **ローカルファースト** — すべてのデータはローカル SQLite に保存、プライバシーを完全保護

## 🖼️ プレビュー

> Markdown レンダリング、シンタックスハイライト、ツール呼び出しの可視化を備えたシンプルな対話インターフェース。すべてのやり取りが明確でコントロール可能です。

<div align="center">
<img src="./resources/shuivx-demo-basic.jpeg" width="680" alt="ShuviX プレビュー">
</div>
